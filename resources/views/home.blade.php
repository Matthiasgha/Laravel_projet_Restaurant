...
{{-- <p>Description : Le Palais des Épices est un restaurant indien chaleureux et 
    authentique qui propose une cuisine traditionnelle avec une touche moderne. Le chef, originaire de Mumbai,
     vous emmène dans un voyage culinaire à travers les régions de l'Inde avec des plats épicés et parfumés qui raviront vos papilles.
      La carte propose une large variété de currys,
     de biryanis, et de pains indiens cuits au four tandoori, ainsi que des options végétariennes et véganes.</p>
